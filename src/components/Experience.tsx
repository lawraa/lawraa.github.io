  ...
  return (
    <section className="py-16 border-t" style={{ borderColor: 'var(--color-border)' }}>
      <div ref={ref} className="reveal">
        <p className="text-xs font-mono uppercase tracking-widest mb-2" style={{ color: 'var(--color-accent)' }}>Experience</p>
        ...
        {/* Publications teaser */}
        <div
          className="rounded-xl px-5 py-4 flex items-start justify-between gap-4 card"
