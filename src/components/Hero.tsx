...
export default function Hero() {
  ...
  return (
    <section className="pt-32 pb-20">
      ...
      <p className="text-base mb-4" style={{ color: 'var(--color-secondary)' }}>
        During my undergraduate studies in Electrical Engineering at National Taiwan University, I worked with Professors <a href="https://shaohua0116.github.io/" target="_blank" className="link-underline font-bold">Shao-Hua Sun</a> and <a href="https://speech.ee.ntu.edu.tw/~hylee/index.php" target="_blank" className="link-underline font-bold">Hung-yi Lee</a>, and published research on multi-agent <a href="https://arxiv.org/abs/2405.06373" target="_blank" className="link-underline font-bold">LLM discussion</a> frameworks for creativity evaluation.
        I have worked as a software engineering intern at <a href="https://www.pegatroncorp.com/" target="_blank" className="link-underline font-bold">Pegatron</a> and <a href="https://www.iadiy.com/" target="_blank" className="link-underline font-bold">IADIY Photonics</a>, conducted an industry-university research collaboration with <a href="https://www.trendforce.com/" target="_blank" className="link-underline font-bold">TrendForce</a>, and served as a research assistant in the <a href="https://nturll.xyz/" target="_blank" className="link-underline font-bold">RLL Lab</a>.
